...
you can use "subprocesses" in parallel, in addition to your normal answer.in backend, we regex:
<< LLM >> -> your normal answer
and
...
<<challenge>> -> user makes any kind of commitment to the future <<challenge>>